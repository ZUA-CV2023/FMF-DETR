...
from ultralytics.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, init_seeds, one_cycle, select_device,
                                           strip_optimizer)
from ultralytics.utils.distill_loss import RTDETRLogicLoss, FeatureLoss
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                with torch.cuda.amp.autocast(self.amp):
                    ...
                    if self.kd_feature_loss is not None and epoch <= stop_kd_epoch:
                        fea_distill_loss = self.kd_feature_loss(s_feature, t_feature) * self.args.feature_loss_ratio * distill_decay
